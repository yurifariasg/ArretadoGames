 ...
 * @author Yuri
 */
public class TreeLogPanel extends EntityPanel<TreeLog> implements ItemPropertyChangedListener {

    /** Creates new form TreeLogPanel */
    public TreeLogPanel(ItemPropertyChangedListener listener) {
        initComponents();
    ...
    @Override
    public void setEntity(TreeLog entity) {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(com.arretados.leveleditor.LevelEditorApp.class).getContext().getResourceMap(TreeLogPanel.class);
